  ...
  return (
    <Card className="shadow-sm container mt-3" style={{ borderRadius: "12px" }}>
      <Container className="py-4">
        ...
        {/* Edit User Modal */}
        <Modal show={showModal} onHide={() => setShowModal(false)} fullscreen="sm-down">
          ...
          <Modal.Body>
            <div className="d-flex flex-column gap-2">
              ...
              <Button
                variant="info"
                onClick={() => {
                  if (selectedUserForActions) handleViewOrders(selectedUserForActions);
                  setShowActionsModal(false);
                }}
              >
                View Orders
...
//   return (
//     <Card
//       className="shadow-sm container mt-3"
...
//               hover
//               responsive
//               className="text-center align-middle px-4"
//             >
//               <thead className="table-dark">
//                 <tr>
//                   <th>#</th>
...
//               <strong>{selectedUserForActions?.name}</strong>
//             </p>
